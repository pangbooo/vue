...
<div>
    <div class="xzqlqd__right">
        ...
        <div :class="['xzqlqd__second',sxlx === 'ggfw'?'xzqlqd__second--ggfw':'']" v-show="searchlist&&searchlist.length>0">
            <el-button :plain="true" type="info" @click="chooseLX('')" :class="['xzqlqd__second__icon','xzqlqd__second__icon--all',select === '' ?'xzqlqd__second-button' : '']">全部({{sum}})</el-button>
            <el-button :plain="true" type="info" v-for="(xz,index) in searchlist" :key="index" @click="chooseLX(xz.SXLX)" :class="['xzqlqd__second__icon','xzqlqd__second__icon--' + xz.SXLXJP  , select === xz.SXLX ? 'xzqlqd__second-button' : '']">{{xz.SXLX}}({{xz.ZS}})</el-button>
        </div>
...
export default{
    ...
    created: function(){
        this.detaillUrl = '/qlqd/xzqlqddetail/index.html?fwlb='+this.title;
    ...
    methods:{
        getData: function(a){
            ...
            if(!this.workup){
                if(this.sxlx==="ggfw"){
                   this.select ? params.filter["服务类别事项"] = this.select:''; 
                }else{
...
.xzqlqd__second .el-button{
    margin:0 0 8px 5px;
    text-align: left;
    padding-left: 37px;
}
.xzqlqd__second .el-button+.el-button {
    margin:0 5px 8px; 
    text-align: left;
    padding-left: 37px;
} 
.xzqlqd__second--ggfw .el-button,.xzqlqd__second--ggfw .el-button+.el-button {
    text-align: center;
    padding-left: 15px;
} 
.xzqlqd__second__icon{
    width: 146px;
    text-align: center;
}
.xzqlqd__second .el-button--info.xzqlqd__second__icon--all {
    background: url(./img/icon_all.png) no-repeat !important;
...
.xzqlqd__second .el-button--info.xzqlqd__second__icon--xzjc {
    background: url(./img/icon_xzjc.png) no-repeat !important;
    background-size: 54% !important;
    background-position: 10px 2px !important;
}
...
.xzqlqd__second .el-button--info.xzqlqd__second__icon--ggfw {
    background: url(./img/icon_ggfw.png) no-repeat !important;
    background-size: 54% !important;
    background-position: 10px 1px !important;
}
</style>