 ...
 * @Last Modified time: 2017-10-07 18:30:11
 */
<template>
<div>
    ...
    <div class="ckpj" id="ckpj">
        <div class="ckpj__content">
            ...
            <div class="ckpj__content__div">
                <h1>{{ title }}</h1>
                <div class="ckpj__content__div__pingfen" :title="rateValue + '分'">
                    <span class="ckpj__content__div__pingfen__title">综合评分：</span>
...
.ckpj__content__div__pingfen__title,
