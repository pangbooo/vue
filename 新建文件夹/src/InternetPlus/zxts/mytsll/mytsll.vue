...
<style scoped>
/* 咨询浏览样式 */
.center{width: 1160px;margin: 0 auto 20px;overflow:hidden; color:#333}
.center .zxlb-right{border:1px solid #ccc;font-size:14px; width: 900px; padding:0  0 50px 0;float: right;overflow:hidden;}
...
.location{margin:0px auto;width: 1160px;height: 50px;}
