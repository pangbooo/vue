...
<script>
  ...
  require('@/components/demo/skin/js/jquery.min.js');
  require('@/components/demo/skin/js/jquery-ui.min.js');
  require('@/components/demo/skin/js/jquery.ui.touch-punch.min.js');
  require('@/components/demo/skin/js/bootstrap.min.js');
  ...
  export default {
    ...
    mounted() {
      let self = this;
      let scripts3 = require('@/components/demo/skin/js/scripts.min.js');
      $("#root").sortable({
        connectWith: ".column",
        opacity: .35,
        handle: ".drag",
