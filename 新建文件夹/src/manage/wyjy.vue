   ...
   components: {
    ...
    data() {
        return {
            ...
            ntype: '',
            fields:{fielddata:[
                {fieldname:'建议标题',width:'',showname:'标题',sortable:true,overflow:true},
                {fieldname:'您的姓名',width:'140',showname:'建议人姓名',sortable:true,overflow:true},
    ...
    methods: {
        ...
        rowDblclick: function(val){
            this.$router.push({path:'/jyhfzxgl', query: {UUID: val.UUID}});
        },
        sortChange: function(){
