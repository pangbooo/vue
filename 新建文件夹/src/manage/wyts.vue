   ...
   components: {
    ...
    data() {
        return {
            ...
            ntype: '',
            fields:{fielddata:[
                {fieldname:'投诉标题',width:'',showname:'主题',sortable:true,overflow:true},
                {fieldname:'被投诉单位',width:'140',showname:'被投诉单位',sortable:true,overflow:true},
                {fieldname:'被投诉人/工号',width:'150',showname:'被投诉人/工号',sortable:true,overflow:true},
                {fieldname:'INSERT_DATE',width:'140',showname:'投诉日期',sortable:true,align:'center',formatter:'formatterdate'},
    ...
    methods: {
        ...
        rowDblclick: function(val){
            this.$router.push({path:'/tshftsgl', query: {UUID: val.UUID}});
        },
        sortChange: function(){
