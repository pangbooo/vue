...
import { getUserInfoAndBuinessInfoList } from '@/api/manage.js';
var getYhglGrid;
if (staticApi.staticApi) {
      getYhglGrid = (params) => {
            ...
            return getUserInfoAndBuinessInfoList(params);
      };
} else {
      getYhglGrid = (params) => {
            return getUserInfoAndBuinessInfoList(params).then(
                  res => {
                        res.data['DataList'] = require('./user.js');
                        return res;
                  }
                  /*
                  res => {
